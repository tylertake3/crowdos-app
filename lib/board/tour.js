...
const TOURS = {
  welcome: {
    ...
    steps: [
      ...
      // only shown once the sample has actually been loaded — promising a
      // sample that isn't there is worse than not mentioning it
      { el:'#sideDemo .side-item', place:'right', title:'A sample schedule to play with',
        body:'This is the made-up schedule you loaded. Click into it and press things — none of it is yours, so you cannot break anything, and you can remove it from the dashboard in one press.' },
